...
export function IconPlay({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
      <path d="M8 5.2c0-.9.98-1.45 1.74-.99l8.6 5.3c.74.46.74 1.53 0 1.99l-8.6 5.3A1.15 1.15 0 0 1 8 15.8z" />
    </svg>
  )
}
...
export function IconSound({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M15.6 9.4a3.7 3.7 0 0 1 0 5.2M18.3 6.9a7.3 7.3 0 0 1 0 10.2" />
    </svg>
  )
}
...
export function IconMute({ className }: IconProps) {
  return (
    ...
    >
      <path d="M4 9.5h3.2L12 5.6v12.8L7.2 14.5H4z" />
      <path d="m16.2 9.6 4.6 4.8M20.8 9.6l-4.6 4.8" />
    </svg>
  )
}
